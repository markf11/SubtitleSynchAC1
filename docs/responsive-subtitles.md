...
the matching display time can be tuned from F1 and saved to the INI.
...
The diagnostic startup tag is now `audio-sync-v5.9-tail-save-lift`. Audio synchronization
